...
import { gameLevels, GAME_BOARD_X_OFFSET, GAME_BOARD_Y_OFFSET } from './GameLevels.ems.js'
import { DATALOADED_EVENT_NAME } from './Loader.esm.js';
import {canvas} from './Canvas.ems.js'
import { Diamond, DIAMOND_SIZE } from './Diamond.ems.js';
import { media } from './Media.esm.js'
import {GameState} from './GameState.ems.js'
import { mouseController } from './MouseController.ems.js';

export const DIAMONDS_ARRAY_WIDTH = 8;
const DIAMONDS_ARRAY_HEIGHT = DIAMONDS_ARRAY_WIDTH + 1;
// pierwsza linia niewidoczna
...
class Game extends Common {
    ...
    handleMouseClick(){
        ...
        if(mouseController.state === 1){
            ...
            if (
                Math.abs(
                mouseController.firstClick.x - mouseController.secondClick.x) + Math.abs(mouseController.firstClick.y - mouseController.secondClick.y) !== 1){
    ...
    swapDiamonds(){
        ...
        this.swap(this.gameState.getGameBoard()[firstDiamond], 
